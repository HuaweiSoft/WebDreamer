...
YAHOO.lang.extend(WireIt.BezierArrowWire, WireIt.BezierWire, {
    ...
    */
   draw: function() {
		/* Adjust the size of arrow  [qhf 2013-07-20]*/
		// var arrowWidth = Math.round(this.width * 1.5 + 20);
		// var arrowLength = Math.round(this.width * 1.2 + 20);
		var arrowWidth = Math.round(this.width * 1.5 + 5);
		var arrowLength = Math.round(this.width * 1.2 + 5);
...
WireIt.Terminal.prototype = {
   ...
   getXY: function() {
       ...
       /* use the container as the layer || modify by  [q00191571 2014-11-20] */
       //var layerEl = this.container && this.container.layer ? this.container.layer.el : document.body;
       var layerEl = this.container && this.container.layer ? this.container.layer.el  : (this.container || document.body);
